...
$timeout=New-RapFixtureReadAdapter Zotero $null EXTERNAL_TIMEOUT;A PR15 ((Invoke-RapExternalReadProbe $timeout).Status-eq'EXTERNAL_TIMEOUT') 'external timeout fails closed'
